...
<footer class="spacer">
        <div class="container">
            <div class="row">
                <div class="col-sm-5">
                    <h4>Hotels Auction</h4>
                    <p>Tus hoteles de confianza</p>
                </div>              
                 
                 <div class="col-sm-3">
                    <h4>Quick Links</h4>
                    <ul class="list-unstyled">
                        <li><a href="formulario1.php">Registrarse</a></li>
                        <li><a href="formulario2.php">Iniciar sesión</a></li>
                        <li><a href="subasta.php">Subastas</a></li>
                        <li><a href="puja.php">Pujas</a></li>
...
<div class="text-center copyright">Powered by <a href="http://thebootstrapthemes.com"></a></div>
